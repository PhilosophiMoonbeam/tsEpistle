...
interface MetricsStateArgs { enabled: boolean }
...
const isAuthenticationResult = (value: unknown): value is AuthenticationResult =>
  typeof value === 'object' && value !== null && !Array.isArray(value)

const isWikiLogger = (value: unknown): value is WikiLogger =>
  typeof value === 'object' && value !== null && typeof Reflect.get(value, 'warn') === 'function'
