...
export const ACTION_CATALOG = {
  ...
  'pages.prepareMove': {
    descriptor: descriptor('pages.prepareMove', 'Prepare page move', 'Prepare an immutable page move proposal against an exact revision.', 'proposal', ['write:pages'], both, proposalAnnotations),
  ...
  'pages.prepareRestore': {
    descriptor: descriptor('pages.prepareRestore', 'Prepare page restore', 'Prepare an immutable restore proposal from one authorized historical version.', 'proposal', ['write:pages'], both, proposalAnnotations),
  ...
  'pages.prepareDelete': {
    descriptor: descriptor('pages.prepareDelete', 'Prepare page deletion', 'Prepare an immutable destructive page deletion proposal.', 'destructive-write', ['delete:pages'], both, proposalAnnotations),
  ...
  'pages.applyProposal': {
    descriptor: descriptor('pages.applyProposal', 'Apply approved proposal', 'Apply one approved immutable proposal after live reauthorization.', 'reversible-write', [], both, applyAnnotations),
