...
export type AvailableEditorsValidation =
  | { ok: true, value: PageEditorKey[] }
  | { ok: false, message: string }

const PAGE_EDITOR_KEY_SET: ReadonlySet<string> = new Set(PAGE_EDITOR_KEYS)

export const isPageEditorKey = (value: unknown): value is PageEditorKey =>
  typeof value === 'string' && PAGE_EDITOR_KEY_SET.has(value)

export const defaultAvailableEditors = (): PageEditorKey[] => [...PAGE_EDITOR_KEYS]
