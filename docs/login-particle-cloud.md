...
The static effect remains transparent and source-faithful. The login field adds no silhouette, shadow, contrast ring, or aura wash behind it. Theme changes update the surrounding UI and backdrop, not the cached particle colors.
