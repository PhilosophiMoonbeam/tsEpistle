...
- A Gemini Interactions request with no declared tools explicitly sends `tool_choice: "none"`, including synthesis after compaction. Declared functions and enabled Google Search retain their existing choice policy. Unexpected provider calls still fail closed without executing an action.
